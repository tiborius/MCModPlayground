package com.tiborius.MCPlayground.reference;

/**
 * Created by tibi on 2014.10.25..
 */
public class Reference {
    public static final String MOD_ID = "MCPlayground";
    public static final String MOD_NAME = "Tiborius' MC Playground mod";
    ...
    public static final String BLOCK_ALBIT = "albitBlock";
}
